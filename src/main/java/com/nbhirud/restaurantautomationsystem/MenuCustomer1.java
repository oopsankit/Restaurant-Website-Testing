  ...
  public void show7_table(){
       try {
         //  Open_table.setVisible(true);
           ...
           Open_table.setRowHeight(30);
           String sql="Select menu_id,mname,quantity,price,quantity*price as 'Total Price' from order_list join menu on menu.menu_id = order_list.menu_id where order_id=" +o.getOrderID();
           pst=mycon.prepareStatement(sql);
           rs=pst.executeQuery();
           Open_table.setModel(DbUtils.resultSetToTableModel(rs));
           }
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txt_menu_id, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
                                    .addComponent(combo_quantity, 0, 104, Short.MAX_VALUE)
